  ...
  return (
    <main className="max-w-2xl mx-auto flex-1 flex flex-col">
      <section className="flex-1 flex flex-col items-center justify-center gap-4 ">
        ...
        >
          <Balancer>
            The Ultimate <span className="bg-gradient-to-r from-rose-300 via-rose-500 to-rose-300 inline-block text-transparent bg-clip-text">UI Builder</span> with a few clicks.
          </Balancer>
        </h1>
        <span
